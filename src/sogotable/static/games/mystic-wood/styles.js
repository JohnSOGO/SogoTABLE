...
.mystic-wood-root .mw-boardwrap{position:relative;overflow:hidden;width:100%;height:min(52vh,78vw);background:#0f1409;border-left:1px solid var(--rule);border-right:1px solid var(--rule)}
