...
- 10,000 publishes a canonical `finish_state` per seat. The standings table header is `?`, and the UI maps the state to hourglass, green check, red X, or both after a farkle ACK.
