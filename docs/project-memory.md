...
- The intro screen shows a Git-backed revision summary. Use Git as the source of truth: human-facing version, short commit hash, branch, and dirty/clean state. Keep the summary short and readable on phones.
