...
import {
  ...
  CLASSIC_GAME_ID, TACTICAL_GAME_ID, BOXES_GAME_ID, BATTLESHIP_GAME_ID, QUORIDOR_GAME_ID, TEN_THOUSAND_GAME_ID, YAHTZEE_GAME_ID, MAZEWRIGHT_GAME_ID, RTTA_GAME_ID, ZOMBIE_DICE_GAME_ID, LIARS_DICE_GAME_ID, NO_THANKS_GAME_ID, HEARTS_GAME_ID, POTION_LAB_GAME_ID, MYSTIC_WOOD_GAME_ID, WNYK_GAME_ID, HEX_ID_PATTERN,
...
test("lists ready games from the hosted game registry", async () => {
  ...
  assert.equal(listed.games[14].name, "Well, Now You Know");
  assert.equal(listed.games[14].player_count, null);
